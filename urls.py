...
urlpatterns = patterns('',
    ...
    #App Management
    (r'^admin/apps/ajax/',apps_ajax_load),
    (r'^admin/apps/create/',apps_management_cerate),
    (r'^admin/apps/view/(\w+)',apps_management_view),
    (r'^admin/apps/modify/(\w+)',apps_management_modify),
    (r'^admin/apps/delete/(\w+)',apps_management_delete),
    (r'^admin/apps/(\w+)',apps_management_list),
