...
class App_World(models.Model):
    url         =   models.CharField(max_length=1024,null=True)
    app_type    =   models.CharField(max_length=50,null=True)
    app_name    =   models.CharField(max_length=1024,null=True)
    category    =   models.ForeignKey(App_category,null=True)
    profile     =   models.CharField(max_length=1024,null=True)
    cover       =   models.CharField(max_length=1024,null=True)
    info_short  =   models.CharField(max_length=1024,null=True)
    info_short_kor  =   models.CharField(max_length=1024,null=True)
    info_long   =   models.TextField(null=True)
    info_long_kor =   models.TextField(null=True)
    date        =   models.DateTimeField(auto_now_add=True)
    ip          =   models.CharField(max_length=15) 
